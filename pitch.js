// pitch.js (ВЕРСИЯ 13.0 - ЗАМЕДЛЕННЫЙ ГРАФИК)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- ИЗМЕНЕНИЕ: УВЕЛИЧИВАЕМ ИСТОРИЮ ГРАФИКА ---
    const PITCH_HISTORY_SIZE = 400; // Было 200. График станет в 2 раза медленнее.
    
    const SMOOTHING_WINDOW_SIZE = 5;
    let pitchHistory = [];

    const MIN_NOTE_NUM = 17; // F2
    const MAX_NOTE_NUM = 60; // C5
    ...
    generatePiano(); drawPitchGraph(); window.addEventListener('resize', drawPitchGraph);
});